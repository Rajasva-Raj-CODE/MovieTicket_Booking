  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
      ...
      <p className="max-w-md text-gray-300">
        The films tell the story of a group of unlikely intergalactic criminals
        who come together to save the galaxy from various threats. The core team
        typically includes Star-Lord, Gamora, Drax, Rocket, and Groot, all of
        whom are unique characters with diverse personalities and backgrounds.
      </p>
      <button
