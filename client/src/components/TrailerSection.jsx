  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden">
      ...
      <div className="relative mt-6">
        <BlurCricle top="100px" right="-100px" />
        {/* Use iframe for YouTube embed */}
        <iframe
          className="mx-auto max-w-full rounded-lg"
          width="960"
          height="540"
          src={
            currentTrailer.videoUrl.includes("youtube.com/watch?v=")
              ? `https://www.youtube.com/embed/${currentTrailer.videoUrl.split("v=")[1]}`
